package top.wjh.boot.quickstart.controller;
...
import top.wjh.boot.quickstart.controller.ArticleController;
import top.wjh.boot.quickstart.controller.ArticleController;
import top.wjh.boot.quickstart.controller.ArticleController;
import top.wjh.boot.quickstart.pojo.Article;
import top.wjh.boot.quickstart.pojo.Reader;
import top.wjh.boot.quickstart.response.AjaxResponse;
...
public class ArticleController {
   ...
   //创建一个para文章
    ...
    public AjaxResponse saveArticleByParams(
            ...
            @RequestParam(value = "author", defaultValue = "wjh", required = false) String author ,
